...
<body>
    ...
    <form action="<c:url value="/admin/reports/update"/>" method="post">
        ...
        <div>
            <label>작성자 ID:</label>
            <input type="text" value="<c:out value="${report.authorId}"/>" readonly />
        </div>
        <button type="submit">보고서 업데이트</button>
    </form>
    <p><a href="<c:url value="/admin/reports/all-reports"/>">모든 보고서 목록으로 돌아가기</a></p>
</body>
</html>