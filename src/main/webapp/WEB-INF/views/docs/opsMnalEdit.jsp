...
<html>
	...
	<body>
		...
		<div id="buttonBtnArea">
			...
			<button type="button" class="blackBtn" onclick='submitForm("<c:url value="/docs/opsMnal.do"/>")'>목록으로</button> 
		</div>
		
		<!-- 목록으로 되돌아갈때 필요 -->
		<form id="hiddenForm" method="post" style="display:none;" action="<c:url value="/docs/opsMnal.do"/>">
...
<script>
	...
	$("#confirmNo").on("click", function() {
  	...
  	$("#confirmYes").on("click", function() {
		 submitForm("<c:url value="/docs/opsMnalUpdate.do"/>");
	});
	
  	function submitForm(actionUrl){
 		const form = actionUrl == "<c:url value="/docs/opsMnal.do"/>" ? document.getElementById("hiddenForm") : document.getElementById("writeFrm");
