...
<html>
	...
	<body>
		            ...
		            <tr>
		                ...
		                <td class="w80p" colspan="3">
		                	<div id="fileAtchArea">
								...
								<input type="file" id="fileInput" name="fileUpload" accept=".hwp, .docx, .pptx, .xlsx">
		...
		<div id="buttonBtnArea">
			...
			<button type="button" class="blackBtn" onclick='submitForm("<c:url value="/docs/safeEdu.do"/>")'>목록으로</button> 
		</div>
		
		<!-- 목록으로 되돌아갈때 필요 -->
		<form id="hiddenForm" method="post" style="display:none;" action="<c:url value="/docs/safeEdu.do"/>">
...
<script>
	...
	$("#confirmNo").on("click", function() {
  	...
  	$("#confirmYes").on("click", function() {
		 submitForm("<c:url value="/docs/safeEduUpdate.do"/>");
	});
	
  	function submitForm(actionUrl){
 		const form = actionUrl == "<c:url value="/docs/safeEdu.do"/>" ? document.getElementById("hiddenForm") : document.getElementById("writeFrm");
