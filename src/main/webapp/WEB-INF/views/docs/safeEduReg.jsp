...
<script>
   ...
   $("#confirmYes").on("click", function() {
      const clickedId = $(this).attr("id");
      const actionUrl = clickedId == "deleteBtn"? "<c:url value="/docs/safeEduDel.do"/>" : "<c:url value="/docs/safeEduInsert.do"/>"
       submitForm(actionUrl);
   });

   function submitForm(actionUrl){
          const form = actionUrl == "<c:url value="/docs/safeEduInsert.do"/>" ? document.getElementById("writeFrm") :  document.getElementById("hiddenForm");
