...
<html>
<head>
    <title>내 <c:out value="${reportTypeDisplayName}"/> 리포트 목록</title>
    <link rel="stylesheet" href="<c:url value="/css/style.css"/>">
</head>
<body>
    <h2>내 <c:out value="${reportTypeDisplayName}"/> 리포트 목록</h2>
    ...
    <p><a href="<c:url value="/employee/reports/create?reportType=${currentReportType}"/>">새 <c:out value="${reportTypeDisplayName}"/> 보고서 작성</a></p>
            ...
            <c:forEach var="report" items="${reports}">
                <tr>
                    ...
                    <td class="report-actions">
                        <a href="<c:url value="/employee/reports/view?id=${report.id}"/>">열람</a> <%-- ★ 열람 링크 추가 ★ --%>
